...
def generate_example_rst(app):
    rootdir = os.path.join(app.builder.srcdir, 'pyvalid_examples')
    exampledir = os.path.join(app.builder.srcdir, 'pyvalid_examples')
...
""")
    ...
    for subdir in subdirs:
        ...
        outputdir = os.path.join(app.builder.outdir, 'pyvalid_examples')
...
"""%(subdir, subdir))
        ...
        for fullpath, fname, contents in data:
            ...
            do_plot = (subdir in ('pyvalid_examples', ) and
